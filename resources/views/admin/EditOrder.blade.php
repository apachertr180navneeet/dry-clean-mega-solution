            ...
            return $item['product_item']['name'];
                                                                        ...
                                                                        <td style="min-width: 100px !important;">
                                                                            <input type="number" name="quantity[]"
                                                                                ...
                                                                                placeholder="Quantity" min="1" step="1" max="1000">
                                                                        </td>
                                                                        <td style="min-width: 100px !important;">
                                                                            <input type="text" name="price[]"
                                                                                class="form-control price"
                                                                                placeholder="Price" min="1" step="1" readonly>
        ...
        document.addEventListener("DOMContentLoaded", function() {
                ...
                $(document).on('click', '.addnewrow', function() {
                    ...
                    let dynamicRowHTML = `
                        <tr>
                            ...
                            <td style="min-width: 100px !important;">
                                <input type="number" name="quantity[]" class="form-control" placeholder="Quantity" value="" min="1" max="1000" step="1">
                                 <span class="error-message text-danger"></span>
                            </td>
            ...
            function captureTableData() {
                ...
                rows.forEach(function(row) {
                    ...
                    // Check for duplicate service within the same type and category
                    let serviceExists = orderItems[categoryIndex].types[typeIndex].services.some(s => s
                        .service === service);
                    if (serviceExists) {
                        isDuplicate = true;
                    } else {
                ...
                if (isDuplicate) {
                    alert(
                        'Duplicate entry detected. The same category, item type, and service combination cannot be added more than once.'
                    );
