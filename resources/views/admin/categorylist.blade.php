                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <select class="form-select" name="item_name" id="dropdown"
                                                    aria-label="Default select example">
                                                    <option selected>Select Item</option>
                                                    @foreach ($clothes_datas as $clothes_data)
                                                        <option value="{{ $clothes_data->id }}">{{ $clothes_data->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <select class="form-select" aria-label="Default select example"
                                                    id="dropdown_upholstrey">
                                                    <option selected>Select Item</option>
                                                    @foreach ($upholstery_datas as $upholstery_data)
                                                        <option value="{{ $upholstery_data->id }}">
                                                            {{ $upholstery_data->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div id="flush-collapse4" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <select class="form-select" aria-label="Default select example"
                                                    id="dropdown_footbags">
                                                    <option selected>Select Item</option>
                                                    @foreach ($footwearandbags as $footwearandbag)
                                                        <option value="{{ $footwearandbag->id }}">
                                                            {{ $footwearandbag->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                ...
                <form method="POST" id="edititemForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <input type="text" name="price" id="edit_price" class="form-control item_price"
                                placeholder="Service price" value="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="edit_item_save"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="Client_table_action_area">
                                <button class="btn Client_table_action_icon px-2 edit_item_btn" data-id="` + item
                        .product_cat_id + `" data-op_id="` + item.operation_id +
                        `" data-name="` + item.product_name + `" data-price="` + item.price + `" data-bs-toggle="modal" data-bs-target="#edit_items"><i class="tf-icons ti ti-pencil"></i></button>
                                <button class="btn Client_table_action_icon px-2 delete_btn" data-id="` + item
                        .product_cat_id + `" data-bs-toggle="modal" data-bs-target="#delete_item"><i class="tf-icons ti ti-trash"></i></button>
                            </div>
                        </td>
                    </tr>
                `;
            ...
            function displayData(data) {
                ...
                data.forEach(function(items) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="Client_table_action_area">
                                <button class="btn Client_table_action_icon px-2 edit_item_btn" data-id="` + items
                        .product_cat_id + `" data-op_id="` + items.operation_id +
                        `" data-name="` + items.product_name + `" data-price="` + items.price + `" data-bs-toggle="modal" data-bs-target="#edit_items"><i class="tf-icons ti ti-pencil"></i></button>
                                <button class="btn Client_table_action_icon px-2 delete_btn" data-id="` + items
                        .product_cat_id + `" data-bs-toggle="modal" data-bs-target="#delete_item"><i class="tf-icons ti ti-trash"></i></button>
                            </div>
                        </td>
                    </tr>
            ...
            function displayFootBagsData(data) {
                ...
                data.forEach(function(items_foot) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="Client_table_action_area">
                                <button class="btn Client_table_action_icon px-2 edit_item_btn" data-id="` + items_foot
                        .product_cat_id + `" data-op_id="` + items_foot.operation_id +
                        `"  data-name="` + items_foot.product_name + `" data-price="` +
                        items_foot.price + `" data-bs-toggle="modal" data-bs-target="#edit_items"><i class="tf-icons ti ti-pencil"></i></button>
                                <button class="btn Client_table_action_icon px-2 delete_btn" data-id="` + items_foot
                        .product_cat_id + `" data-bs-toggle="modal" data-bs-target="#delete_item"><i class="tf-icons ti ti-trash"></i></button>
                            </div>
                        </td>
                    </tr>
            ...
            function displayOtherData(data) {
                ...
                data.forEach(function(other) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="Client_table_action_area">
                                <button class="btn Client_table_action_icon px-2 edit_item_btn" data-id="` + other
                        .product_cat_id + `" data-op_id="` + other.operation_id +
                        `"  data-name="` + other.product_name + `" data-price="` + other.price + `" data-bs-toggle="modal" data-bs-target="#edit_items">
                                    <i class="tf-icons ti ti-pencil"></i>
                                </button>
                                <button class="btn Client_table_action_icon px-2 delete_btn" data-id="` + other
                        .product_cat_id + `" data-bs-toggle="modal" data-bs-target="#delete_item">
            ...
            function displayLaundryData(data) {
                ...
                data.forEach(function(laundry) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="Client_table_action_area">
                                <button class="btn Client_table_action_icon px-2 edit_item_btn" data-id="` + laundry
                        .product_cat_id + `" data-op_id="` + laundry.operation_id +
                        `"  data-name="` + laundry.product_name + `" data-price="` + laundry
                        .price + `" data-bs-toggle="modal" data-bs-target="#edit_items">
                                    <i class="tf-icons ti ti-pencil"></i>
                                </button>
                                <button class="btn Client_table_action_icon px-2 delete_btn" data-id="` + laundry
                        .product_cat_id + `" data-bs-toggle="modal" data-bs-target="#delete_item">
                                    <i class="tf-icons ti ti-trash"></i>
                                </button>
                            </div>
