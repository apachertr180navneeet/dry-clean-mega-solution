...
Route::get('/receipt-print/{orderId}', [App\Http\Controllers\Tenant\OrderController::class, 'RecieptPrint'])->middleware(['auth'])->name('receipt-print');
Route::get('/invoice-print/{orderId}', [App\Http\Controllers\Tenant\OrderController::class, 'InvoicePrint'])->middleware(['auth'])->name('invoice-print');
//for paymnt settle
